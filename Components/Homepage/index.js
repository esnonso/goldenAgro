    ...
    <Container flex="column" width="100%" margin="3.5rem 0 0 0">
      ...
      <div className={classes["advert-two"]}>
        ...
        <Container flex="column" align="center" justify="center">
          <PTags textAlign="left" margin="2rem 0">
            <span className={classes["star"]}>★</span>Breakfast is the most
            important meal of the day
            <br />
            <span className={classes["star"]}>★</span>Golden Agro premium rice
            contains Vitamin D from healthy bones
            <br />
            <span className={classes["star"]}>★</span> Give yourself and family
            a nutritous and premium breakfast
          </PTags>
        </Container>
      </div>
      ...
      <ContainerFlexColumn margin="1rem 0 0 0" padding="0 2%" wrap="wrap">
